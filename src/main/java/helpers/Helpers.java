...
public class Helpers {
    ...
    public static ArrayList<String> getUniqElement(ArrayList<String> firstList, ArrayList<String> secondList) {
        ArrayList<String> differences = new ArrayList<>(firstList);
        differences.removeAll(secondList);
        return differences;
    }

    public static ArrayList<String> trimList(ArrayList<String> original) {
